...
def upgrade() -> None:
    ...
    op.create_index("ix_portfolios_deleted_at", "portfolios", ["deleted_at"])
    ...
    op.create_index("ix_asset_prices_asset_id_date", "asset_prices", ["asset_id", "price_date"])
    op.create_index("ix_memberships_org_id", "memberships", ["org_id"])
    op.create_index("ix_memberships_user_id", "memberships", ["user_id"])
    op.create_index("ix_ai_conversations_org_id_user_id", "ai_conversations", ["org_id", "user_id"])
    ...
    op.create_index("ix_portfolios_org_deleted", "portfolios", ["org_id", "deleted_at"])
    op.create_index("ix_holdings_org_deleted", "holdings", ["org_id", "deleted_at"])
    op.create_index("ix_transactions_org_deleted", "transactions", ["org_id", "deleted_at"])
